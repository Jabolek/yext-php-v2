...
class Duplicate implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'status', must be one of 'POSSIBLE_DUPLICATE', 'SUPPRESSION_REQUESTED', 'SUPRESSED', 'UNAVAILABLE', 'DELETED'.";
        }
    ...
    /**
     * Sets name
     * @param string $name The business name that appears on the duplicate listing
     * @return $this
     */
    ...
    /**
     * Sets address
     * @param string $address The address that appears on the duplicate listing
     * @return $this
     */
    ...
    /**
     * Sets phone
     * @param string $phone The phone number that appears on the duplicate listing
     * @return $this
     */
    ...
    /**
     * Sets latitude
     * @param string $latitude The latitude of the location, as shown on the duplicate listing (e.g., in a map view)
     * @return $this
     */
    ...
    /**
     * Sets longitude
     * @param string $longitude The longitude of the location, as shown on the duplicate listing (e.g., in a map view)
     * @return $this
     */
     ...
     * @param \Yext\Client\Model\DuplicateUnavailableReason[] $unavailable_reasons List of reasons why suppression is unavailable for this duplicate listing (will be empty unless **`status`** is `UNAVAILABLE`)
     * @return $this
     */
