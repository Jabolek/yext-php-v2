...
/**
 * EventSection Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class EventSection implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EventSection';
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'items' => '\Yext\Client\Model\EventItem[]'
    ];
    ...
    /**
     * Gets items
     * @return \Yext\Client\Model\EventItem[]
     */
    ...
    /**
     * Sets items
     * @param \Yext\Client\Model\EventItem[] $items Section Items.
     * @return $this
     */
