<?php
/**
 * AvailableServiceResponseResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AvailableServiceResponseResponse Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AvailableServiceResponseResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AvailableServiceResponse_response';
    ...
    protected static $swaggerTypes = [
        'available_services' => '\Yext\Client\Model\AvailableService[]'
    ];
    ...
    protected static $setters = [
        'available_services' => 'setAvailableServices'
    ];
    ...
    {
        $this->container['available_services'] = isset($data['available_services']) ? $data['available_services'] : null;
    }
     ...
     * @return \Yext\Client\Model\AvailableService[]
     */
    public function getAvailableServices()
    {
        return $this->container['available_services'];
    }

    /**
     * Sets available_services
     * @param \Yext\Client\Model\AvailableService[] $available_services
     * @return $this
     */
    public function setAvailableServices($available_services)
    {
        $this->container['available_services'] = $available_services;
