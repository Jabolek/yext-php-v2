...
class ResponseMeta implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'uuid' => 'string',
        'errors' => '\Yext\Client\Model\ResponseError[]'
    ];
    ...
    /**
     * Sets uuid
     * @param string $uuid Unique ID for this request / response.
     * @return $this
     */
    ...
    /**
     * Gets errors
     * @return \Yext\Client\Model\ResponseError[]
     */
    ...
    /**
     * Sets errors
     * @param \Yext\Client\Model\ResponseError[] $errors List of errors and warnings.
     * @return $this
     */
