...
class BioSection implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BioSection';
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'items' => '\Yext\Client\Model\BioItem[]'
    ];
    ...
    /**
     * Gets items
     * @return \Yext\Client\Model\BioItem[]
     */
    ...
    /**
     * Sets items
     * @param \Yext\Client\Model\BioItem[] $items Section Items.
     * @return $this
     */
