...
class Asset implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'type', must be one of 'TEXT', 'PHOTO', 'VIDEO'.";
        }
    ...
    /**
     * Sets labels
     * @param string[] $labels List of text labels for this Asset.
     * @return $this
     */
    ...
    /**
     * Sets contents
     * @param \Yext\Client\Model\AssetTextContent[] $contents Text content, localized.  **NOTE:** At least one entry must be for the account's primary locale.
     * @return $this
     */
    ...
    /**
     * Sets photo_url
     * @param string $photo_url URL to the photo asset.  **Required when asset **`type`** is ``PHOTO``.** Must be a valid URL to a photo asset. Cannot be updated once the asset is created.
     * @return $this
     */
    ...
    /**
     * Sets details
     * @param string $details Details text.  Only valid when asset **`type`** is ``PHOTO``.
     * @return $this
     */
     ...
     * @param string $clickthrough_url Clickthrough URL.  Only valid when asset **`type`** is ``PHOTO``.
     * @return $this
     */
    ...
    /**
     * Sets alternate_text
     * @param string $alternate_text Alternate text for accessibility purposes.  Only valid when asset **`type`** is ``PHOTO``.
     * @return $this
     */
    ...
    /**
     * Sets video_url
     * @param string $video_url URL to the YouTube video.  **Required when asset **`type`** is ``VIDEO``.** Must be a valid URL to a YouTube video. Cannot be updated once the asset created.
     * @return $this
     */
