...
/**
 * SocialCommentsResponseResponse Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SocialCommentsResponseResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SocialCommentsResponse_response';
    ...
    /**
     * Sets count
     * @param int $count Total number of Comments that meet filter criteria (ignores limit/offset)
     * @return $this
     */
