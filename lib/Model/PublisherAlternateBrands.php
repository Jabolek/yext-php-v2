...
/**
 * PublisherAlternateBrands Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PublisherAlternateBrands implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Publisher_alternateBrands';
    ...
    /**
     * Sets name
     * @param string $name Alternate brand name
     * @return $this
     */
    ...
    /**
     * Sets url
     * @param string $url Alternate brand's home page
     * @return $this
     */
