...
class Account implements ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['location_count'] = isset($data['location_count']) ? $data['location_count'] : null;
        $this->container['sub_account_count'] = isset($data['sub_account_count']) ? $data['sub_account_count'] : null;
        $this->container['parent_account_id'] = isset($data['parent_account_id']) ? $data['parent_account_id'] : null;
    }
    ...
    /**
     * Sets location_count
     * @param int $location_count Number of locations in this account
     * @return $this
     */
     ...
     * @param int $sub_account_count Number of sub-accounts directly under this account, if any
     * @return $this
     */
     ...
     * @param string $parent_account_id Customer-provided ID of the account that this is a sub-account of, if any. Not provided if this is a top-level account.
     * @return $this
     */
