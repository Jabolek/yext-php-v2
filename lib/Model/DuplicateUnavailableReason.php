...
/**
 * DuplicateUnavailableReason Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DuplicateUnavailableReason implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DuplicateUnavailableReason';
    ...
    /**
     * Sets code
     * @param string $code Unique code for the unavailable reason
     * @return $this
     */
    ...
    /**
     * Sets reason
     * @param string $reason Explanation for why the listing is unavailable
     * @return $this
     */
