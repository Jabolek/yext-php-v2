...
/**
 * ContentListCostOption Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContentListCostOption implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContentListCostOption';
    ...
    /**
     * Sets name
     * @param string $name e.g., Small, Medium, Large, Add Bacon.
     * @return $this
     */
    ...
    /**
     * Sets price
     * @param string $price A simple price in USD, e.g., 1.00.
     * @return $this
     */
    ...
    /**
     * Sets calorie
     * @param int $calorie How many calories this option adds. This field is for Menu items only.
     * @return $this
     */
