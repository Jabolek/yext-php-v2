...
/**
 * GoogleOption Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GoogleOption implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GoogleOption';
    ...
    /**
     * Sets id
     * @param string $id Google's ID for the option.
     * @return $this
     */
    ...
    /**
     * Sets label
     * @param string $label <msg>Google's display name for the option.<msg>
     * @return $this
     */
