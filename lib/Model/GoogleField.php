 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GoogleField implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GoogleField';
    ...
    protected static $swaggerTypes = [
        'label' => 'string',
        'id' => 'string',
        'options' => '\Yext\Client\Model\GoogleOption[]'
    ];
    ...
    /**
     * Sets label
     * @param string $label Google's display name for the field.
     * @return $this
     */
    ...
    /**
     * Sets id
     * @param string $id Google's ID for this field.
     * @return $this
     */
    ...
    /**
     * Gets options
     * @return \Yext\Client\Model\GoogleOption[]
     */
    ...
    /**
     * Sets options
     * @param \Yext\Client\Model\GoogleOption[] $options
     * @return $this
     */
