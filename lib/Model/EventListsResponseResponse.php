...
/**
 * EventListsResponseResponse Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class EventListsResponseResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EventListsResponse_response';
    ...
    /**
     * Sets count
     * @param int $count Total number of Event Lists that meet filter criteria (ignores limit / offset).
     * @return $this
     */
