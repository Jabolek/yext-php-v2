...
/**
 * ProductSection Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductSection implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductSection';
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'items' => '\Yext\Client\Model\ProductItem[]'
    ];
    ...
    /**
     * Gets items
     * @return \Yext\Client\Model\ProductItem[]
     */
    ...
    /**
     * Sets items
     * @param \Yext\Client\Model\ProductItem[] $items Section Items.
     * @return $this
     */
