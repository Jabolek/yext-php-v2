 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MenuSection implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'items' => '\Yext\Client\Model\MenuItem[]'
    ];
    ...
    /**
     * Gets items
     * @return \Yext\Client\Model\MenuItem[]
     */
    ...
    /**
     * Sets items
     * @param \Yext\Client\Model\MenuItem[] $items Section Items.
     * @return $this
     */
