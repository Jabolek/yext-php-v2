...
/**
 * CancelServicesRequest Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CancelServicesRequest implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CancelServicesRequest';
    ...
    /**
     * Sets agreement_id
     * @param int $agreement_id The ID of the agreement under which you want services canceled. You do not need to supply this except in advanced scenarios.
     * @return $this
     */
    ...
    /**
     * Sets skus
     * @param string[] $skus List of SKUs that you would like to cancel on the location. The location must have active services for all provided SKUs. If you do not provide a list of SKUs, all active services for the location will be canceled.
     * @return $this
     */
