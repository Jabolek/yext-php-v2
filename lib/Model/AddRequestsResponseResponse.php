...
/**
 * AddRequestsResponseResponse Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AddRequestsResponseResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddRequestsResponse_response';
    ...
    protected static $swaggerTypes = [
        'add_requests' => '\Yext\Client\Model\AddRequest[]'
    ];
    ...
    {
        $this->container['add_requests'] = isset($data['add_requests']) ? $data['add_requests'] : null;
    }
    ...
    /**
     * Gets add_requests
     * @return \Yext\Client\Model\AddRequest[]
     */
    public function getAddRequests()
    {
        return $this->container['add_requests'];
    }

    /**
     * Sets add_requests
     * @param \Yext\Client\Model\AddRequest[] $add_requests
     * @return $this
     */
    public function setAddRequests($add_requests)
    {
        $this->container['add_requests'] = $add_requests;
