...
/**
 * ContentListPhoto Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContentListPhoto implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContentListPhoto';
    ...
    /**
     * Sets height
     * @param int $height Dimension in pixels.
     * @return $this
     */
    ...
    /**
     * Sets width
     * @param int $width Dimension in pixels.
     * @return $this
     */
