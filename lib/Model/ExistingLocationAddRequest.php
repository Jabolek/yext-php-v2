...
/**
 * ExistingLocationAddRequest Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ExistingLocationAddRequest implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExistingLocationAddRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['existing_location_id'] === null) {
            $invalid_properties[] = "'existing_location_id' can't be null";
        }
     ...
     * @param string $existing_location_id ID of the location to add service for. It must already be in your account (or, if you use the Partner Portal, any of your sub-accounts).
     * @return $this
     */
     ...
     * @param string $existing_location_account_id *(Partner Portal mode only)* If the *existingLocationId* you specified is not unique among your sub-accounts, use this to specify which account the existing location is in.
     * @return $this
     */
