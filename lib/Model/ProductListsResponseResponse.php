...
/**
 * ProductListsResponseResponse Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductListsResponseResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductListsResponse_response';
    ...
    /**
     * Sets count
     * @param int $count Total number of Product Lists that meet filter criteria (ignores limit / offset).
     * @return $this
     */
