...
/**
 * NewLocationAddRequest Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class NewLocationAddRequest implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NewLocationAddRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['new_location_id'] === null) {
            $invalid_properties[] = "'new_location_id' can't be null";
        }
     ...
     * @param string $new_location_id Your ID for the location to be added.
     * @return $this
     */
     ...
     * @param string $new_location_account_id *(Partner Portal mode)* Partner Portal mode, supply your ID for the account that the new location should be created in. If this is your main account or an existing sub-account, the location will be placed there. Otherwise, a new account will be created.
     * @return $this
     */
     ...
     * @param string $new_account_parent_account_id *(Partner Portal mode, advanced use only)* If you have a multi-layer account structure and want the new account created for this request to be under one of your sub-accounts, rather than directly under your main account, specify that sub-account here.
     * @return $this
     */
