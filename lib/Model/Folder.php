...
class Folder implements ArrayAccess
{
    ...
    /**
     * Sets id
     * @param string $id The Yext Folder ID number. If the folder is the customer-level (root) folder, its `id` will be \"0\".
     * @return $this
     */
    ...
    /**
     * Sets parent_id
     * @param string $parent_id The ID of the folder that contains the folder.
     * @return $this
     */
