...
class PostEntry implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'status', must be one of 'NOT_POSTED', 'LIVE', 'DELETED'.";
        }
    ...
    /**
     * Sets timestamp
     * @param int $timestamp Timestamp this PostEntry was created, as reported by the publisher (milliseconds since epoch).
     * @return $this
     */
