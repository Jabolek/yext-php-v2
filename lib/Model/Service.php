...
class Service implements ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['stop_on_date'] = isset($data['stop_on_date']) ? $data['stop_on_date'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["ACTIVE", "STOPPED"];
        if (!in_array($this->container['status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'status', must be one of 'ACTIVE', 'STOPPED'.";
        }
    ...
    /**
     * Sets id
     * @param int $id Yext ID for the service. This is useful only to get service detail with the `GET` endpoint.
     * @return $this
     */
     ...
     * @param string $location_account_id *(Partner Portal mode only)* The account that the location receiving service is in.
     * @return $this
     */
    ...
    /**
     * Sets agreement_id
     * @param int $agreement_id The ID of your agreement with Yext under which this service is being delivered. This is important to you only in advanced scenarios where you have set up multiple active agreements with Yext.
     * @return $this
     */
     ...
     * @return \DateTime
     */
    public function getStopOnDate()
    {
        return $this->container['stop_on_date'];
    }

    /**
     * Sets stop_on_date
     * @param \DateTime $stop_on_date Future date on which the service should be stopped if it's still active when that date arrives.
     * @return $this
     */
    public function setStopOnDate($stop_on_date)
    {
        $this->container['stop_on_date'] = $stop_on_date;
    ...
    {
        $allowed_values = array('ACTIVE', 'STOPPED');
        if (!is_null($status) && (!in_array($status, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'status', must be one of 'ACTIVE', 'STOPPED'");
        }
