...
/**
 * MenuListsResponseResponse Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MenuListsResponseResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MenuListsResponse_response';
    ...
    /**
     * Sets count
     * @param int $count Total number of Menus that meet filter criteria (ignores limit / offset).
     * @return $this
     */
