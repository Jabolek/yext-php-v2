...
/**
 * RolesResponseResponse Class Doc Comment
 *
 * @category    Class
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RolesResponseResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RolesResponse_response';
    ...
    /**
     * Sets count
     * @param int $count Total number of Roles that meet filter criteria (ignores limit / offset)
     * @return $this
     */
    ...
    /**
     * Sets roles
     * @param \Yext\Client\Model\Role[] $roles
     * @return $this
     */
