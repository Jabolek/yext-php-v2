...
class AssetForLocations implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['label_operator'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'label_operator', must be one of 'AND', 'OR'.";
        }
    ...
    /**
     * Sets folder_id
     * @param string $folder_id The **external** folder ID for the locations this asset can be used for.  Optional - can only be set if **`mappingType`** is ``FOLDER``.
     * @return $this
     */
    ...
    /**
     * Sets location_ids
     * @param string[] $location_ids The list of **external** IDs for the locations this asset can be used for.  Optional - can only be set if **`mappingType`** is ``LOCATIONS``.
     * @return $this
     */
    ...
    /**
     * Sets label_ids
     * @param string[] $label_ids The list of **external** IDs of the labels applied to the locations this asset can be used for.  Optional - can only be set if **`mappingType`** is ``FOLDER`` or ``ALL_LOCATIONS``.
     * @return $this
     */
    ...
    /**
     * Sets label_operator
     * @param string $label_operator The operator on the IDs in **`labelIds`** - indicates whether the list includes any of (``OR``) or all of (``AND``) the IDs.  Optional - can only be set if **`mappingType`** is ``FOLDER`` or ``ALL_LOCATIONS``.
     * @return $this
     */
