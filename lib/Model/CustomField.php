...
class CustomField implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['group'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'group', must be one of 'NONE', 'GROUP_1', 'GROUP_2', 'GROUP_3', 'GROUP_4', 'GROUP_5', 'GROUP_6', 'GROUP_7', 'GROUP_8', 'GROUP_9', 'GROUP_10'.";
        }
        ...
        if (!in_array($this->container['type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'type', must be one of 'BOOLEAN', 'DAILY_TIMES', 'DATE', 'GALLERY', 'HOURS', 'MULTILINE_TEXT', 'MULTI_OPTION', 'NUMBER', 'PHOTO', 'SINGLE_OPTION', 'TEXT', 'TEXT_LIST', 'URL', 'VIDEO', 'VIDEO_GALLERY'.";
        }
